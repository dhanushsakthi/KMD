...
export const products = [
  ...
  },
  {
    ...
    image: image15,
    icon: "🫓",
    description: "Multigrain atta is a nutritious flour made from a blend of several whole grains, like wheat, millets (Finger Millet) and sometimes lentils (Black Chana dal) or maize, offering more fiber, protein, vitamins, and minerals than single-grain flour, making softer rotis and improving digestion. It's a popular, wholesome choice for healthier Indian flatbreads (chapatis/rotis) and adds diverse nutrients for better metabolism and overall health.",
    benefits: ["Rich in fiber", "Protein rich", "Supports metabolism", "Makes softer rotis"],
    moq: "100 units",
    ingredients: "Whole Wheat. Finger Millet, Pearl Millet, White Sorghum, Yellow Maize, Green Gram, Black Chana.",
    directions: "Mixing KMD Whole Atta Flour mix with water and a little Oil / Salt to form a soft dough.\n\nResting 15 Minutes. Rolling small portions into thin circles / balls and cooking then on a hot tawa."
  },
];
